 class GrantAI extends AIInfo 
 {
   function GetAuthor()      { return "Grant"; }
   function GetName()        { return "GrantAI"; }
   function GetDescription() { return "World domination AI"; }
   function GetVersion()     { return 1; }
   function GetDate()        { return "2009-07-29"; }
   function CreateInstance() { return "GrantAI"; }
   function GetShortName()   { return "GMAI"; }
